...
const FAQ_ITEMS = [
  { q: "Что если мне не понравится дизайн?", a: "3 цикла правок включены в стоимость каждого пакета. Дополнительные итерации — 159 Br за цикл. Наш опыт показывает, что первая версия дизайна устраивает в 90% случаев." },
